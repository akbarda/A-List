...
class ItemActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Fungsi untuk melakukan penambahan list
        fab_item.setOnClickListener {
            val dialog = AlertDialog.Builder(this)
            dialog.setTitle("Tambah List Progress")
    ...
    //Fungsi untuk melakukan update pada list
    fun updateItem(item :ToDoItem ){
        val dialog = AlertDialog.Builder(this)
        dialog.setTitle("Update List Progress")
        val view = layoutInflater.inflate(R.layout.dialog_dashboard, null)
        val toDoName = view.findViewById<EditText>(R.id.ev_todo)
    ...
    class ItemAdapter(val activity: ItemActivity, val list: MutableList<ToDoItem>) :
        ...
        //Fungsi untuk melakukan mark pada list
        override fun onBindViewHolder(holder: ViewHolder, p1: Int) {
            ...
            holder.delete.setOnClickListener {
                ...
                dialog.setMessage("Anda Ingin Menghapus Item Ini ?")
